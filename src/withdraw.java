...
public class withdraw {
    withdraw(String name, String cid) {
        JFrame f = new JFrame("Withdraw");
        JLabel withdrawJLabel = new JLabel("Enter amount to be witdraw :");
        JTextField amounTextField = new JTextField();
        JButton okButton = new JButton("Ok");
        JButton backButton = new JButton("Back");
        Font font = new Font("Roboto", Font.PLAIN, 30);
        withdrawJLabel.setBounds(400, 200, 400, 40);
        withdrawJLabel.setFont(font);
            ...
            public void actionPerformed(ActionEvent event) {
                if (amounTextField.getText().length() == 0) {
                    ...
                    JOptionPane.showMessageDialog(f,
                            Operation.withdrawMoney(cid, s, Integer.parseInt(amounTextField.getText())));
